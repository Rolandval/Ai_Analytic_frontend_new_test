...
var animateNumber = (t2, n2, s2, e2, c2) => {
  ...
  const frame = (s3) => {
    ...
    const f2 = i2 - a2;
    const _2 = f2 >= u2;
    const d3 = s3 ? 1 : 1 - (o(0, a2 + u2 - i2) / u2 || 0);
    const p3 = (n2 - t2) * (isFunction(c2) ? c2(d3, d3 * u2, 0, 1, u2) : d3) + t2;
    const v2 = _2 || d3 === 1;
    if (e2) {
      e2(p3, d3, v2);
    }
...
var addEventListener = (t2, n2, o2, s2) => {
  var e2;
  const c2 = (e2 = s2 && s2.T) != null ? e2 : true;
...
var $t = (() => ({
  [Ct]: {
    static: () => (t2, n2, o2) => {
      ...
      const g3 = [appendChildren(t2, c2), addEventListener(u2, e2, onScroll), addEventListener(a2, e2, onScroll)];
      addClass(t2, et);
      setStyles(f2, {
        [C]: s2,
        [$]: s2
      ...
      l(reset);
      return [o2 ? bind(onScroll, false) : reset, g3];
    }
  }
}))();
...
var zt = (() => ({
  [Et]: {
    static: () => (t2, n2, o2, s2) => {
      ...
      const d3 = animateNumber(0, f2, i2, (r3, i3, a3) => {
        t2(r3);
        if (a3) {
          s2(e2);
          if (!e2) {
...
var createEnvironment = () => {
  ...
  const g3 = assignDeep({}, Tt);
  const h2 = bind(assignDeep, {}, g3);
  ...
  if (isFunction(n.matchMedia) && !_2 && (!d3.x || !d3.y)) {
...
var createDOMObserver = (t2, n2, o2, s2) => {
  ...
  const [d3, p3] = createEventContentChange(t2, _2, i2);
  const v2 = c2 || [];
  const g3 = r2 || [];
  const h2 = concat(v2, g3);
  const observerCallback = (e3, c3) => {
    if (!isEmptyArray(c3)) {
      ...
      let v3 = false;
      each(c3, (o3) => {
        const { attributeName: e4, target: c4, type: a3, oldValue: u3, addedNodes: p4, removedNodes: h3 } = o3;
        const b3 = a3 === "attributes";
        const w3 = a3 === "childList";
        const y2 = t2 === c4;
        const S3 = b3 && e4;
        const m2 = S3 && getAttr(c4, e4 || "");
        const O3 = isString(m2) ? m2 : null;
        const C3 = S3 && u3 !== O3;
        const $2 = inArray(g3, e4) && C3;
        if (n2 && (w3 || !y2)) {
          const n3 = b3 && C3;
          const a4 = n3 && l2 && is(c4, l2);
          const _4 = a4 ? !r3(c4, e4, u3, O3) : !b3 || n3;
          const d5 = _4 && !i3(o3, !!a4, t2, s2);
          each(p4, (t3) => push(f2, t3));
          each(h3, (t3) => push(f2, t3));
          v3 = v3 || d5;
        }
        if (!n2 && y2 && C3 && !r3(c4, e4, u3, O3)) {
          push(_3, e4);
          d4 = d4 || $2;
        }
      });
      p3((t3) => deduplicateArray(f2).reduce((n3, o3) => {
        push(n3, find(t3, o3));
      ...
      if (!isEmptyArray(_3) || d4) {
        const t3 = [deduplicateArray(_3), d4];
        if (!e3) {
          o2.apply(0, t3);
        }
        return t3;
...
var createObserversSetup = (t2, n2, o2, s2) => {
  ...
  const { dt: p3, vt: v2, L: g3, gt: h2, ht: b2, V: w3, bt: y2, wt: S3, yt: m2, St: O3 } = t2;
  const getDirectionIsRTL = (t3) => getStyles(t3, "direction") === "rtl";
  const C3 = {
    Ot: false,
    B: getDirectionIsRTL(p3)
  };
  const $2 = getEnvironment();
  ...
  const [H2] = createCache({
    ...
    const s3 = x2 && x2.R(t2, n2, C3, $2, o2).Y;
    const e3 = y2 && w3;
  ...
  const [z2, T2] = b2 ? createTrinsicObserver(v2, onTrinsicChanged) : [];
  const I2 = !w3 && createSizeObserver(v2, onSizeChanged, {
    ft: true
  });
  const [A2, M2] = createDOMObserver(v2, false, onHostMutation, {
    ct: _2,
    et: _2
  });
  const k2 = w3 && d && new d((t3) => {
  ...
  return [() => {
    ...
    const [p4, v3] = t3("update.elementEvents");
    ...
    if (S4) {
      ...
      const [t4, n4] = createDOMObserver(b2 || g3, true, onContentMutation, {
        et: concat(_2, a3 || []),
        rt: p4,
        it: u2,
        ut: (t5, n5) => {
          const { target: o4, attributeName: s4 } = t5;
          const e3 = !n5 && s4 && !w3 ? liesBetween(o4, u2, f2) : false;
...
var createScrollbarsSetupElements = (t2, n2, o2, s2) => {
  ...
  const { slot: a2 } = l2;
  const { dt: u2, vt: f2, L: _2, At: d3, gt: v2, bt: g3, V: h2 } = n2;
  const { scrollbars: b2 } = d3 ? {} : t2;
  const { slot: w3 } = b2 || {};
  const y2 = [];
  const S3 = [];
  const m2 = [];
  const O3 = dynamicInitializationElement([u2, f2, _2], () => h2 && g3 ? u2 : f2, a2, w3);
  ...
  const scrollbarsAddRemoveClass = (t3, n3, o3) => {
    ...
    const c3 = s3 ? !o3 : true;
    if (e3) {
      scrollbarStructureAddRemoveClass(S3, t3, n3);
    }
    if (c3) {
  ...
  const refreshScrollbarsHandleLength = () => {
    ...
    scrollbarStyle(S3, createScrollbarStyleFn(t3.x));
  ...
  const refreshScrollbarsHandleOffset = () => {
    if (!p) {
      ...
      scrollbarStyle(S3, createScrollbarStyleFn(n3.x));
  ...
  const refreshScrollbarsScrollbarOffset = () => {
    if (h2 && !g3) {
      ...
      scrollbarStyle(S3, styleScrollbarPosition);
  ...
  const appendElements = () => {
    appendChildren(O3, S3[0].Lt);
    appendChildren(O3, m2[0].Lt);
...
var createScrollbarsSetupEvents = (t2, n2, o2, s2) => (r2, i2, l2) => {
  const { vt: u2, L: f2, V: _2, gt: d3, Gt: p3, St: v2 } = n2;
  const { Lt: g3, Ut: h2, Mt: b2 } = r2;
  const [w3, y2] = selfClearTimeout(333);
  const [S3, m2] = selfClearTimeout(444);
  const scrollOffsetElementScrollBy = (t3) => {
    if (isFunction(d3.scrollBy)) {
      d3.scrollBy({
        behavior: "smooth",
        left: t3.x,
        top: t3.y
  ...
  const createInteractiveScrollEvents = () => {
    ...
    return addEventListener(h2, "pointerdown", (o3) => {
      ...
      const _3 = l3 ? b2 : h2;
      const g4 = t2.scrollbars;
      const w4 = g4[l3 ? "dragScroll" : "clickScroll"];
      const { button: y3, isPrimary: O4, pointerType: C3 } = o3;
      const { pointers: $2 } = g4;
      const x2 = y3 === 0 && O4 && w4 && ($2 || []).includes(C3);
      if (x2) {
        runEachAndClear(f3);
        m2();
        const t3 = !l3 && (o3.shiftKey || w4 === "instant");
        const g5 = bind(getBoundingClientRect, b2);
        const y4 = bind(getBoundingClientRect, h2);
        const getHandleOffset = (t4, n4) => (t4 || g5())[i3] - (n4 || y4())[i3];
        const O5 = e(getBoundingClientRect(d3)[r3]) / I(d3)[a2] || 1;
        const C4 = createRelativeHandleMove(getElementScroll(d3)[u3], 1 / O5);
        const $3 = o3[s3];
        const x3 = g5();
        const H2 = y4();
        const E3 = x3[r3];
        const z2 = getHandleOffset(x3, H2) + E3 / 2;
        const T2 = $3 - H2[i3];
        const A2 = l3 ? 0 : T2 - z2;
        ...
        const D2 = l3 || t3;
        const M2 = v2();
        const k2 = [addEventListener(p3, n3, releasePointerCapture), addEventListener(p3, "selectstart", (t4) => preventDefault(t4), {
          T: false
        }), addEventListener(h2, n3, releasePointerCapture), D2 && addEventListener(h2, "pointermove", (t4) => C4(A2 + (t4[s3] - $3))), D2 && (() => {
          const t4 = getElementScroll(d3);
          M2();
          const n4 = getElementScroll(d3);
          const o4 = {
            x: n4.x - t4.x,
            y: n4.y - t4.y
          };
  ...
  let O3 = true;
  return bind(runEachAndClear, [addEventListener(b2, "pointermove pointerleave", s2), addEventListener(g3, "pointerenter", () => {
    i2(ht, true);
  }), addEventListener(g3, "pointerleave pointercancel", () => {
    i2(ht, false);
  }), !_2 && addEventListener(g3, "mousedown", () => {
    ...
    T: false,
    I: true
  }), addEventListener(g3, "pointerdown", () => {
    const t3 = addEventListener(p3, "click", (t4) => {
      n3();
      stopAndPrevent(t4);
    }, {
      A: true,
    ...
    const n3 = addEventListener(p3, "pointerup pointercancel", () => {
      n3();
      setTimeout(t3, 150);
    }, {
      I: true,
...
var createScrollbarsSetup = (t2, n2, o2, s2, e2, c2) => {
  ...
  let _2 = 0;
  const d3 = ["mouse", "pen"];
  const isHoverablePointerType = (t3) => d3.includes(t3.pointerType);
  const [p3, v2] = selfClearTimeout();
  const [g3, h2] = selfClearTimeout(100);
  const [b2, w3] = selfClearTimeout(100);
  const [y2, S3] = selfClearTimeout(() => _2);
  const [m2, O3] = createScrollbarsSetupElements(t2, e2, s2, createScrollbarsSetupEvents(n2, e2, s2, (t3) => isHoverablePointerType(t3) && manageScrollbarsAutoHideInstantInteraction()));
  const { vt: C3, Kt: $2, bt: H2 } = e2;
  const { Ft: z2, Pt: T2, Nt: I2, qt: A2, Bt: D2 } = m2;
  ...
  const M2 = [S3, h2, w3, v2, () => f2(), addEventListener(C3, "pointerover", onHostMouseEnter, {
    A: true
  }), addEventListener(C3, "pointerenter", onHostMouseEnter), addEventListener(C3, "pointerleave", (t3) => {
    if (isHoverablePointerType(t3)) {
      r2 = false;
      if (l2) {
        manageScrollbarsAutoHide(false);
  ...
  }), addEventListener(C3, "pointermove", (t3) => {
  ...
  return [() => bind(runEachAndClear, push(M2, O3())), ({ zt: t3, It: n3, Qt: e3, Zt: c3 }) => {
    const { tn: r3, nn: d4, sn: p4, en: v3 } = c3 || {};
    const { Ct: g4, ft: h3 } = e3 || {};
    const { B: w4 } = o2;
    const { k: y3, U: S4 } = getEnvironment();
    const { cn: m3, j: O4 } = s2;
    const [C4, M3] = t3("showNativeOverlaidScrollbars");
    const [R2, V2] = t3("scrollbars.theme");
    const [L2, U2] = t3("scrollbars.visibility");
    const [P2, N2] = t3("scrollbars.autoHide");
    const [q3, B2] = t3("scrollbars.autoHideSuspend");
    const [F3] = t3("scrollbars.autoHideDelay");
    const [j2, X2] = t3("scrollbars.dragScroll");
    const [Y2, W2] = t3("scrollbars.clickScroll");
    const [J2, G2] = t3("overflow");
    const K2 = h3 && !n3;
    const Q2 = O4.x || O4.y;
    const Z2 = r3 || d4 || v3 || g4 || n3;
    const tt2 = p4 || U2 || G2;
    const nt2 = C4 && y3.x && y3.y;
    const ot2 = !S4 && !k2;
    const st2 = nt2 || ot2;
...
var createStructureSetupElements = (t2) => {
  ...
  const { padding: _2, viewport: d3, content: p3 } = f2 || {};
  const v2 = a2 ? t2 : u2.target;
  const g3 = isBodyElement(v2);
  const h2 = v2.ownerDocument;
  const b2 = h2.documentElement;
  const getDocumentWindow = () => h2.defaultView || n;
  const w3 = bind(staticInitializationElement, [v2]);
  const y2 = bind(dynamicInitializationElement, [v2]);
  const S3 = bind(createDiv, "");
  const C3 = bind(w3, S3, i2);
  const $2 = bind(y2, S3, l2);
  ...
  const appendElements = () => {
    ...
    focusElement(!H2 && g3 && n2 === Y2 && t3.top === t3 ? Q2 : n2);
    c3();
    st2 = 0;
    return ct2;
  };
...
var createTrinsicUpdateSegment = ({ ht: t2 }) => ({ Qt: n2, un: o2, It: s2 }) => {
  const { $t: e2 } = n2 || {};
  const { Ot: c2 } = o2;
  const r2 = t2 && (e2 || s2);
  if (r2) {
...
var createPaddingUpdateSegment = ({ vt: t2, rn: n2, L: o2, V: s2 }, e2) => {
  ...
  return ({ zt: t3, Qt: i2, un: l2, It: a2 }) => {
    let [u2, f2] = r2(a2);
    const { U: _2 } = getEnvironment();
    const { _t: d3, xt: p3, Ct: m2 } = i2 || {};
    const { B: O3 } = l2;
    ...
    if (E3) {
      ...
      const r3 = {
        ...
        [w]: t4 && O3 ? -s3 : 0,
        top: t4 ? -u2.t : 0,
        right: t4 ? O3 ? -u2.r : "auto" : 0,
        left: t4 ? O3 ? "auto" : -u2.l : 0,
        [C]: t4 && `calc(100% + ${s3}px)`
      };
      const i3 = {
        [v]: t4 ? u2.t : 0,
...
var createOverflowUpdateSegment = (t2, s2) => {
  ...
  const { vt: c2, rn: r2, L: i2, V: a2, Kt: u2, gt: f2, bt: _2, yt: d3, an: p3 } = t2;
  const { U: v2 } = e2;
  const g3 = _2 && a2;
  const h2 = bind(o, 0);
  const b2 = {
  ...
  const setViewportOverflowStyle = (t3) => {
    ...
    d3(n2);
    d3(keys(t3).map((n3) => createViewportOverflowStyleClassName(t3[n3], n3 === "x")).join(" "), true);
  };
  const [m2, O3] = createCache(y2, bind(getFractionalSize, i2));
  const [C3, $2] = createCache(y2, bind(D, i2));
  const [z2, T2] = createCache(y2);
  const [I2] = createCache(S3);
  const [M2, k2] = createCache(y2);
  const [R2] = createCache(S3);
  const [V2] = createCache({
    i: (t3, n2) => equal(t3, n2, w3),
    o: {}
  }, () => hasDimensions(i2) ? getStyles(i2, w3) : {});
  ...
  return ({ zt: n2, Qt: o2, un: l2, It: a3 }, { _n: u3 }) => {
    const { _t: f3, Ht: _3, xt: b3, Ct: w4, ft: y3, Et: S4 } = o2 || {};
    const x2 = P2 && P2.R(t2, s2, l2, e2, n2);
    const { X: H2, Y: E3, W: D2 } = x2 || {};
    const [q3, F3] = getShowNativeOverlaidScrollbars(n2, e2);
    const [j2, X2] = n2("overflow");
    const Y2 = overflowIsVisible(j2.x);
    const W2 = overflowIsVisible(j2.y);
    const J2 = f3 || u3 || b3 || w4 || S4 || F3;
    let G2 = O3(a3);
    let Q2 = $2(a3);
    let tt2 = T2(a3);
    let nt2 = k2(a3);
    ...
    const dt2 = u3 || w4 || S4 || at2 || it2 || st2 || ct2 || X2 || F3 || J2 || _3 && g3;
    const [pt2, vt2] = V2(a3);
    const gt2 = w4 || y3 || vt2 || ft2 || a3;
...
var createSetups = (t2, n2, o2, s2, e2) => {
  ...
  const [_2, d3, p3] = createObserversSetup(u2, a2, r2, (t3) => {
    update({}, t3);
  });
  const [v2, g3, , h2] = createScrollbarsSetup(t2, n2, p3, a2, u2, e2);
  const updateHintsAreTruthy = (t3) => keys(t3).some((n3) => !!t3[n3]);
  const update = (t3, e3) => {
    if (o2()) {
      return false;
    }
    const { dn: r3, It: i3, Tt: a3, pn: u3 } = t3;
    const f3 = r3 || {};
    const _3 = !!i3 || !c2;
    const v3 = {
    ...
    const w3 = updateHintsAreTruthy(h3);
    const y2 = updateHintsAreTruthy(b2);
    const S3 = w3 || y2 || !isEmptyObject(f3) || _3;
    c2 = true;
    if (S3) {
      s2(t3, {
        Qt: h3,
...
var OverlayScrollbars = (t2, n2, o2) => {
  ...
  if (n2 && !r2) {
    ...
    const [d3, p3, v2] = createEventListenerHub(o2);
    const triggerEvent = (t3, n3) => {
      v2(t3, n3);
      _2(t3, n3);
    };
    const [g3, h2, b2, w3, y2] = createSetups(t2, a2, () => r3, ({ dn: t3, It: n3 }, { Qt: o3, Zt: s3 }) => {
      const { _t: e3, Ct: c3, $t: r4, xt: i3, Ht: l3, ft: a3 } = o3;
      const { tn: u3, nn: f3, sn: _3, en: d4 } = s3;
      triggerEvent("updated", [S3, {
        updateHints: {
          sizeChanged: !!e3,
          directionChanged: !!c3,
    ...
    }, (t3) => triggerEvent("scroll", [S3, t3]));
    const destroy = (t3) => {
      removeInstance(c2);
      runEachAndClear(i2);
      r3 = true;
      triggerEvent("destroyed", [S3, t3]);
      f2();
      p3();
    };
    const S3 = {
      ...
      elements() {
        const { dt: t3, vt: n3, rn: o3, L: s3, ht: e3, gt: c3, Kt: r4 } = w3.hn;
        const { jt: i3, Jt: l3 } = w3.bn;
    ...
    push(i2, [y2]);
    addInstance(c2, S3);
    registerPluginModuleInstances(M, OverlayScrollbars, [S3, u2, l2]);
    if (cancelInitialization(w3.hn.bt, !e2 && t2.cancel)) {
      destroy(true);
      return S3;
    }
    push(i2, g3());
    triggerEvent("initialized", [S3]);
    S3.update();
    return S3;
  }
  return r2;
...
var S2 = () => {
  ...
  let l2, o2;
  const t2 = window, c2 = typeof t2.requestIdleCallback == "function", a2 = t2.requestAnimationFrame, i2 = t2.cancelAnimationFrame, r2 = c2 ? t2.requestIdleCallback : a2, u2 = c2 ? t2.cancelIdleCallback : i2, s2 = () => {
    u2(l2), i2(o2);
  };
  return [
    (n2, e2) => {
...
var F2 = (l2) => {
  const { options: o2, events: t2, defer: c2 } = l2 || {}, [a2, i2] = (0, import_react.useMemo)(S2, []), r2 = (0, import_react.useRef)(null), u2 = (0, import_react.useRef)(c2), s2 = (0, import_react.useRef)(o2), n2 = (0, import_react.useRef)(t2);
    ...
    () => [
      (e2) => {
        ...
        if (OverlayScrollbars.valid(v2))
          return;
        const f2 = u2.current, y2 = s2.current || {}, b2 = n2.current || {}, m2 = () => r2.current = OverlayScrollbars(e2, y2, b2);
        f2 ? a2(m2, f2) : m2();
      },
      () => r2.current
    ],
...
var q2 = (l2, o2) => {
  const { element: t2 = "div", options: c2, events: a2, defer: i2, children: r2, ...u2 } = l2, s2 = t2, n2 = (0, import_react.useRef)(null), e2 = (0, import_react.useRef)(null), [v2, f2] = F2({ options: c2, events: a2, defer: i2 });
  return (0, import_react.useEffect)(() => {
  ...
  }, [v2, t2]), (0, import_react.useImperativeHandle)(
    o2,
    () => ({
      osInstance: f2,
      getElement: () => n2.current
    }),
    []
  ), // @ts-ignore
  import_react.default.createElement(s2, { "data-overlayscrollbars-initialize": "", ref: n2, ...u2 }, t2 === "body" ? r2 : import_react.default.createElement("div", { "data-overlayscrollbars-contents": "", ref: e2 }, r2));
};
var g2 = (0, import_react.forwardRef)(q2);
export {
  g2 as OverlayScrollbarsComponent,
  F2 as useOverlayScrollbars
};
