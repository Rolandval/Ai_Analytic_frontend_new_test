...
import { useCreateSolarPanelTask } from '@/hooks/useCreateSolarPanelTask';
import { useRunSolarPanelTask } from '@/hooks/useRunSolarPanelTask';
...
const TaskAutomationPage = () => {
  ...
  const { data: tasks, isLoading } = useGetSolarPanelTasks(currentPage, ITEMS_PER_PAGE);
  const createTask = useCreateSolarPanelTask();
  const runTask = useRunSolarPanelTask();
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-3xl font-bold">Автоматизація завдань для сонячних панелей</h1>
