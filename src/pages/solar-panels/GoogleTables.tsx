...
const SolarGoogleTablesPage = () => {
  ...
  const handleRunImport = async (id: number) => {
    try {
      ...
      const data = await runSolarPanelGoogleTableImport(id);
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-3xl font-bold">Збережені таблиці (Сонячні панелі)</h1>
...
export default SolarGoogleTablesPage;
