...
import { useGetInverterSuppliers } from '@/hooks/useGetInverterSuppliers';
import { useAddInverterSupplier } from '@/hooks/useAddInverterSupplier';
import { useUpdateInverterSupplier } from '@/hooks/useUpdateInverterSupplier';
import { useDeleteInverterSupplier } from '@/hooks/useDeleteInverterSupplier';
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent>
          ...
          <DialogFooter>
            ...
            <Button onClick={handleSave} disabled={addSupplier.isPending || updateSupplier.isPending}>
...
export default InverterSuppliersPage;
