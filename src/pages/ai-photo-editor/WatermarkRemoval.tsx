...
import { Droplets, Upload, X, Download, ArrowLeftRight } from 'lucide-react';
import { useRemoveWatermark } from '@/hooks/useWatermarkRemoval';
...
export default function AIPhotoEditorWatermarkRemoval() {
  ...
  const processImage = async (imageId: string, file: File) => {
    ...
    try {
      const result = await removeWatermarkMutation.mutateAsync({
        image: file,
        data: {
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400 mt-1">
                Автоматичне виявлення та видалення watermark
              </p>
            </div>
          </div>
        </div>
        ...
        <Card className="mt-6">
          ...
          <CardContent>
            <ol className="list-decimal list-inside space-y-2 text-sm text-gray-600 dark:text-gray-400">
              <li>Завантажте зображення з водяним знаком</li>
              <li>AI автоматично виявить та видалить watermark</li>
