...
import { useCreateBatteryTask } from '@/hooks/useCreateBatteryTask';
import { useRunBatteryTask } from '@/hooks/useRunBatteryTask';
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-3xl font-bold">Автоматизація завдань для акумуляторів</h1>
